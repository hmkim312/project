...
```python
# Extract all keywords and create a single list
all_keywords = [keyword for sublist in data['keywords'] for keyword in sublist]

# Create a Series from the list for easy counting
...
# Create the word cloud with the uploaded mask
...
# Display the word cloud with the uploaded mask
